        ...
        children: [
          Consumer<APIProvider>(
            builder: (context, apiProvider, child) {
              if (apiProvider.factData != null) {
                return Text(apiProvider.factData!.fact);
              } else {
          ...
          // FutureBuilder<Fact>(
          //   future: apiProvider.getApi1Data(),
          //   builder: (context, snapshot) {
          //     if (snapshot.connectionState == ConnectionState.waiting) {
          //       return const CircularProgressIndicator(); // Replace with your desired loading indicator
          //     } else if (snapshot.hasError) {
          //       return Text('Error: ${snapshot.error}');
          //     } else {
          //       factData = snapshot.data!;
